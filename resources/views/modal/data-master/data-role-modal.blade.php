<x-modal id="tambahData" title="Tambah Role" action="actionTambah">
    <x-form type="text" name="name">
        Nama
    </x-form>
</x-modal>
<x-modal id="ubah" title="Ubah Role" action="actionUbah">
    <x-form type="text" name="name">
        Nama
    </x-form>
</x-modal>
<x-modal.hapus id="hapus" action="actionHapus">
    <p class="text-center">Apakah anda yakin ingin menghapus role <b>{{$name}}</b>?</p>
</x-modal.hapus>
