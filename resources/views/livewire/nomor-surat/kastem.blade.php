<div>
    <x-content>
        ...
        <div class="row mb-3" wire:poll.keep-alive>
            <div class="col">
                <div class="card shadow-md">
                    <div class="card-header text-center">
                        <h5>Nomor Surat Kastem</h5>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mg-b-20">
                                                <div class="input-group ">
                                                    ...
                                                    <select id="slug" wire:model.live='slug'
                                                        class="form-select form-control-sm @error('slug') is-invalid @enderror">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <x-button.index class=" btn-sm btn-secondary">backdate</x-button.index>
            ...
            <div class="mg-b-20">
                <div class="d-flex justify-content-center">
                    <div class="row mb-3 bg-primary rounded">
                        <div class="col">
                            <button class="btn btn-primary" wire:model="generate" @if($generate=='' ) disabled @endif
                                wire:click="$set('generate',
                                '')">
                                All Data
                            </button>
                            <button class="btn btn-primary" wire:model="generate" @if($generate==Auth::user()->id)
                                disabled @endif wire:click="$set('generate',
                                '{{Auth::user()->id}}')">
                                Nomor Surat Saya
                            </button>
                        </div>
